...
const Register = () => {
  ...
  const validate = () => {
    ...
    if (formData.role === 'Super Admin' && !formData.adminKey) {
      newErrors.adminKey = 'Admin Security Key is required for Super Admin';
    }
        ...
        <div className="w-full max-w-[490px] bg-white rounded-[24px] border border-slate-300 shadow-md p-5 sm:p-6 transition-all">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="pt-0.5">
              ...
              <div className="grid grid-cols-4 gap-1.5">
                ...
                >
                  ...
                  <span className="text-[9px] font-bold tracking-tight">Citizen</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[9px] font-bold tracking-tight text-ellipsis overflow-hidden whitespace-nowrap w-full">NGO</span>
                </button>
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-2 rounded-lg border text-center transition-all cursor-pointer ${formData.role === 'Super Admin'
                    ? 'border-[#0052cc] bg-[#f0f5ff] text-[#0052cc]'
                    : 'border-slate-300 bg-white hover:border-slate-400 text-slate-600'
                    }`}
                >
            ...
            {formData.role === 'Super Admin' && (
              <div className="pt-0.5 text-left animate-in fade-in duration-200">
                <label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase tracking-wider">Admin Security Key</label>
                <input
                  type="password"
                  name="adminKey"
                  ...
                  className={`w-full px-3 py-2 rounded-lg border bg-white text-slate-800 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/10 placeholder-slate-400 shadow-sm transition-all ${errors.adminKey ? 'border-red-500 focus:border-red-500' : 'border-slate-300 focus:border-[#0052cc]'
                    }`}
                />
                {errors.adminKey && <p className="text-red-500 text-[10px] mt-0.5">{errors.adminKey}</p>}
              </div>
            )}
